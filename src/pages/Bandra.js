        ...
        <section className='city_landing' >
          <div className='city_landing_top' >
            ...
            transition={{
              ...
              <motion.p className="city_paragraph" initial={{opacity:0, translateX:'-100px'}} animate={{opacity:1, translateX:'0px'}} transition={{duration:0.7, delay:3}} >Bandra: Where Bollywood meets Bohemian chic on the streets of Mumbai.</motion.p>
            ...
            transition={{
              ...
              <motion.div className='bandra_right_img'  
              // animate={{
            //     opacity:[0,1],
            //   scaleX: [0,1],
            //   translateX:['-550px','0px']
          ...
          <motion.div className='bandra_landing_bottom'  animate={{
                opacity:[0,1,1],
              scaleX: [0.7,0.7,1],
